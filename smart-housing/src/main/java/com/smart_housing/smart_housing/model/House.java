...
public class House {
    ...
    public House(int landlordId, String location, double rent, String amenities, String imagePath, String status) {
    ...
    public void setLandlordId(Landlord landlordId) { this.landlordId = landlordId; }
